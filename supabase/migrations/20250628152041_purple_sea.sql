/*
  # Fix Infinite Recursion in Family Members Policies

  1. Problem
    - Infinite recursion detected in policy for relation "family_members"
    - This occurs when policies reference each other in a circular way
    - The error happens when trying to access family_members table

  2. Solution
    - Drop all existing problematic policies
    - Create new, non-recursive policies using SECURITY DEFINER functions
    - Implement proper access control without circular references
    - Use direct checks where possible to avoid complex nested queries
*/

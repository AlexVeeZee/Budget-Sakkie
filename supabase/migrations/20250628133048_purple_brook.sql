/*
  # Fix User Profiles Schema and RLS Policies

  1. Add Missing Location Fields
    - `phone_number` (text)
    - `address` (text)
    - `city` (text)
    - `province` (text)
  ...
  2. Fix RLS Policies
    ...
    - Update policies to use these functions to prevent recursion
    - Ensure proper access control for user profiles

  3. Create Helper Functions
    - Add functions to check table existence
    - Add functions to get table schema
    - Add functions for dataframe storage
*/
